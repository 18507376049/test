								...
								<tr>
												...
												<tr>
													<td style="text-align: center">
														<table width="80%" border="0" cellspacing="0"
															...
															<form action="userInfoManagerServlet" method="get">
															<tr>
																<td
															...
															<tr>
																...
																<td style="text-align: left"><input name="userPass"
																	type="text" class="textinput" /></td>
															</tr>
															<tr>
															...
															<tr>
																<td colspan="2"
																	...
																	type="hidden" name="choose" value="login" /> 
																	<input
																		type="image" onclick="return formcheck()"
															...
															<tr>
																<td colspan="2"
																	style="padding-top: 10px; text-align: center">登录帮助&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;帮助中心&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;忘记密码
																</td>
															</tr>
															<tr>
															...
															<tr>
																<td colspan="2"
																	...
																	href="register.jsp"> <input type="image"
									...
									<td style="text-align: left; padding-top: 30px; width: 60%"><h1>您还没有注册？</h1>
										...
										<p style="text-align: right">
											<a href="register.jsp"> <input type="image"
												src="images/signupbutton.gif" width="135" height="33" />
											</a>
										</p></td>
								</tr>
